...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <InternalLayoutProvider>
      <div className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.08),_transparent_28%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)] text-slate-900 font-sans">
        ...
        <div className="relative mx-auto flex min-h-screen max-w-[1920px] flex-col lg:flex-row">
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <main className="flex-1 px-4 pb-6 pt-4 md:px-6 md:pb-8 md:pt-4 lg:px-8 lg:pt-6">
