      ...
      while (true) {
        ...
        const response = await fetch("/api/enhance/batch", {
          ...
          body: JSON.stringify({
            ...
            qualityStrictness: Number(formData.qualityStrictness) || 60,
          }),
        });
  ...
  const handleSaveResults = async () => {
    ...
    const promise = fetch("/api/leads/save", {
      ...
      body: JSON.stringify({
        ...
        qualityStrictness: Number(formData.qualityStrictness) || 60,
        employeeRangeMin: formData.employeeRangeMin
          ? Number(formData.employeeRangeMin)
          : undefined,
        employeeRangeMax: formData.employeeRangeMax
          ? Number(formData.employeeRangeMax)
          : undefined,
                      ...
                      {currentStep === 3 && (
                        ...
                        >
                          ...
                          <div className="space-y-6">
                              ...
                              <div className="space-y-3">
                                ...
                                <div className="grid gap-3 grid-cols-2">
                                  <input
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="SMB"
                                    className="w-full px-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 outline-none transition-all text-sm font-bold placeholder:text-slate-300"
                                  />
                                  <input
                                    name="batchName"
                            ...
                            <div className="bg-indigo-50/50 border border-indigo-100 p-8 rounded-[1.5rem] space-y-6">
                              ...
                              <div className="grid gap-4 md:grid-cols-4">
                                <div className="space-y-2">
                                  ...
                                  <input
                                    ...
                                    value={formData.employeeRangeMin}
                                    onChange={handleInputChange}
                                    placeholder="1"
                                    className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold outline-none focus:ring-2 focus:ring-blue-100"
                                  />
                                ...
                                <div className="space-y-2">
                                  ...
                                  <input
                                    ...
                                    value={formData.employeeRangeMax}
                                    onChange={handleInputChange}
                                    placeholder="50"
                                    className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-sm font-bold outline-none focus:ring-2 focus:ring-blue-100"
                                  />
                              ...
                              <div className="space-y-2">
                                ...
                                <input
                                  ...
                                  max={100}
                                  step={5}
                                  name="qualityStrictness"
                                  value={formData.qualityStrictness}
                                  onChange={handleInputChange}
