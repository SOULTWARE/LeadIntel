...
void LegacyTermsOfServicePage;

function LegacyTermsOfServicePage() {
      ...
      >
        ...
        <section className="mx-auto max-w-4xl space-y-6 rounded-[2.5rem] border border-white/70 bg-white/75 p-8 text-center shadow-[0_24px_80px_-40px_rgba(15,23,42,0.32)] backdrop-blur-2xl md:p-12">
          ...
          >
            ...
            platform. By using Lead Intel Pro, you agree to these terms.
          </motion.p>
        ...
        {sections.map((section, index) => (
          <motion.section
            key={index}
            variants={itemVariants}
            className="rounded-[2rem] border border-white/70 bg-white/80 p-6 shadow-[0_18px_60px_-36px_rgba(15,23,42,0.25)] backdrop-blur-xl md:p-8"
          >
        ...
        >
          ...
          <p className="text-slate-300 leading-relaxed">
            ...
            provide notice of material changes by posting the new Terms on this
            page and updating the &quot;Effective Date&quot; above. Your
