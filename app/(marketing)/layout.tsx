          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="space-y-5">
              ...
              <p className="max-w-xl text-sm leading-6 text-slate-500">
                A focused lead intelligence workspace for teams that need
                qualified sourcing, AI enrichment, and outreach readiness in one
                streamlined flow.
              </p>
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  "AI enrichment",
                  "Email discovery",
                  "Revenue-ready exports",
                ].map((item) => (
                  <span
                    key={item}
                    className="rounded-full border border-slate-200 bg-white px-4 py-2 text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 shadow-sm"
                  >
                    {item}
                  </span>
                ))}
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              <div>
                <h4 className="text-xs font-black uppercase tracking-[0.35em] text-slate-400 mb-4">
                  Product
                </h4>
