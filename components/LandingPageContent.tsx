                  ...
                  <div className="px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                      {[
                        ...
                        <div key={`${s.title}-${s.date}`} className="bg-white border border-slate-200 rounded-[2rem] shadow-xl shadow-slate-100/50 overflow-hidden">
                          <div className="p-7">
                                ...
                                {[1, 2, 3].map((step) => (
                                  <div key={step} className="flex items-center flex-1 last:flex-none">
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm transition-all duration-500 ${
                                      step <= 2 ? 'bg-blue-600 text-white shadow-lg shadow-blue-100' : 'bg-slate-200 text-slate-500'
                                    }`}>
                                      {step}
                                    </div>
                                    {step < 3 && (
                                      <div className={`h-1 flex-1 mx-4 rounded-full transition-all duration-700 ${step < 2 ? 'bg-blue-600' : 'bg-slate-200'}`} />
                                    )}
                                  </div>
                                ))}
                              </div>
                                              ...
                                              <td className="px-8 py-6 max-w-[300px]">
                                                <div className="space-y-2">
                                                  <div className={`text-[10px] font-black uppercase px-2 py-1 rounded-lg w-fit shadow-sm border ${
                                                    ...
                                                    r.recommendation === 'Recommended' ? 'bg-blue-50 text-blue-700 border-blue-100' :
                                              ...
                                              <td className="px-8 py-6">
                                                <div className="flex flex-col items-center gap-1">
                                                  ...
                                                  <div className="w-16 h-1 bg-slate-100 rounded-full overflow-hidden">
                                                    <div className={`h-full ${r.score >= 80 ? 'bg-green-500' : 'bg-blue-500'}`} style={{ width: `${r.score}%` }} />
                                                  </div>
                                                </div>
                                              </td>
                                            </tr>
                          ...
                          <div className="px-8 relative h-full">
                            <div className="relative left-1/2 -translate-x-1/2 origin-top scale-[0.72] w-[149.89%] h-[148.89%]">
                              ...
                              {[
                                ...
                                <div key={s.name} className="group relative bg-white p-7 rounded-[2rem] border border-slate-200 shadow-lg overflow-hidden">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-1">
                                      ...
                                      <div className="text-xl font-black text-slate-800 flex items-center gap-2">4.8 <span className="text-amber-400 text-base">★</span><span className="text-xs text-slate-400">(238 reviews)</span></div>
                                    </div>
                                    <div className="bg-slate-50 p-6 rounded-3xl border border-slate-100 space-y-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                  <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                      {[
                                        ...
                                        <div key={p} className="flex items-start gap-3 p-4 bg-red-50/50 rounded-2xl border border-red-50 text-red-800 text-xs font-bold uppercase transition-transform hover:translate-x-1">
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div className="flex flex-col gap-2">
                                      {[
                                        'Modern booking flow',
                                        'SEO + landing improvements',
                                        'Review-driven trust signals',
                                      ].map((h) => (
                                        <div key={h} className="flex items-start gap-3 p-4 bg-green-50/50 rounded-2xl border border-green-50 text-green-800 text-xs font-bold uppercase transition-transform hover:translate-x-1">
