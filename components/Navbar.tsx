        ...
        <div className="flex flex-col gap-4 px-4 py-4 lg:px-6">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 md:gap-4">
              <Link
                href="/"
                className="flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white px-3 py-2 shadow-sm transition-transform hover:-translate-y-0.5"
              >
            ...
            <nav className="hidden items-center gap-3 lg:flex">
              <Link
                href="/pricing"
                className="rounded-full px-4 py-2 text-sm font-semibold text-slate-600 transition-colors hover:text-blue-600"
              >
                Pricing
              </Link>
              <Link
              ...
              {user ? (
                ...
                <div className="ml-2 flex items-center gap-3">
                  <Link
                    href="/login"
                    className="rounded-2xl bg-slate-950 px-5 py-3 text-sm font-black text-white shadow-lg shadow-slate-900/10 transition-transform hover:-translate-y-0.5"
                  >
                    Get Started
                  </Link>
                </div>
          ...
          <div className="flex gap-2 overflow-x-auto pb-1 lg:hidden">
            {[
              ...
              <Link
                key={item.href}
                href={item.href}
                className="whitespace-nowrap rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.25em] text-slate-500 transition-colors hover:border-blue-200 hover:text-blue-600"
              >
                {item.label}
              </Link>
            ))}
