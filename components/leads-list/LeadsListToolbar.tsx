      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col gap-4 shadow-sm">
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
          <div className="flex-1 w-full">
            <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] block mb-2">Contact Purpose</label>
            <textarea
              value={leadPurpose}
              onChange={(e) => onLeadPurposeChange(e.target.value)}
              placeholder="Describe why you're contacting these leads..."
              rows={2}
              className="w-full px-4 py-3 rounded-2xl border border-slate-200 bg-slate-50 text-sm font-medium focus:ring-4 focus:ring-blue-100 outline-none resize-none"
            />
          </div>
          <button
            type="button"
            ...
            className="inline-flex items-center gap-2 px-6 py-4 bg-indigo-600 text-white rounded-2xl text-sm font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all disabled:opacity-50 disabled:shadow-none cursor-pointer"
          >
